...
export const Navbar = () => {
    return (
        <nav className='fixed mx-auto top-0 left-0 right-0 z-10 bg-[#2F4858] bg-opacity-100'>
            <div className="flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 py-2">
                ...
                <div className="menu hidden md:block mb:w-auto" id='navbar'>
                    <ul className="flex items-center p-4 md:p-0 md:flex-row md:space-x-8 mt-0">
                        <li>
                            <Link href={"#about"} className='block py-2 pl-3 pr-4 text-[#FFC57C] sm:text-xl rounded md:p-0 hover:text-white '>
                                About Me
                            </Link>
                        </li>
                        <li>
