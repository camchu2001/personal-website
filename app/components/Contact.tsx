...
export const Contact = () => {
  return (
    <section id="contact" className='mt-24'>
      ...
      <form className="mt-6 flex flex-wrap flex-col">
        <input type="email" name='senderEmail' placeholder='Your email ' maxLength={500} required 
          className='p-2 mb-4 rounded-md border-black'/> 
        ...
        <textarea name="message" placeholder="Your message " maxLength={5000} required
          className='p-2 mb-4 h-[px] rounded-md border-black border-shadow'>
        </textarea>

        <div className="flex flex-wrap flex-col items-center">
          <button type="submit" className='rounded-lg bg-black p-2 w-[100px] flex items-center'>
